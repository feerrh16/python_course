...
class Conexion:
    ...
    def obtener_pool(cls):
        if cls._pool is None:
            try:
                ...
                log.debug(f'Creación exitosa del pool de conexiones:\n{cls._pool}')
                return cls._pool
            except Exception as e:
                log.error(f'Ocurrió un error al obtener el pool de conexiones:\n{e}')
                sys.exit()
        else:
            return cls._pool
    ...
    def liberar_conexion(cls, conexion):
        ...
        log.debug(f'Conexión regresada al pool de conexiones:\n{conexion}')
